...
const ClaimProcess = () => {
  const steps = [
    {
      icon: <ClipboardCheck className="h-8 w-8 text-[#2AAA8A]" />,
    ...
    {
      icon: <UserCheck className="h-8 w-8 text-[#2AAA8A]" />,
    ...
    {
      icon: <FileText className="h-8 w-8 text-[#2AAA8A]" />,
    ...
    {
      icon: <Scale className="h-8 w-8 text-[#2AAA8A]" />,
    ...
    {
      icon: <Coins className="h-8 w-8 text-[#2AAA8A]" />,
  ...
  return (
    <section id="claim-process" className="py-20 bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
              ...
              {steps.map((step, index) => (
                <motion.div key={index} variants={itemVariants} className="relative group">
                  ...
                  >
                    {/* Step Icon Circle */}
                    <div
                      className="w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-xl group-hover:shadow-2xl transition-all duration-300 group-hover:scale-110 border-4"
        ...
        >
          <div className="bg-accentGreen rounded-3xl p-8 md:p-12 text-white shadow-2xl relative overflow-hidden">
            <div className="relative z-10">
              ...
              >
                ...
                <span className="font-bold text-white" style={{ color: colors.accentGreen }}>
              ...
              <p className="text-xl opacity-90 mb-8 max-w-2xl mx-auto leading-relaxed text-black">
                Act now – deadlines can be strict. Schedule your complimentary consultation today to
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                <motion.div whileHover={{ scale: 1.05, y: -3 }} whileTap={{ scale: 0.98 }}>
                  ...
                  >
                    <Link href="#case-evaluation" className="flex items-center">
                      ...
                      <span className="text-black">Begin Your Free Case Evaluation</span>
                      <motion.div
                        className="ml-3"
                        animate={{ x: [0, 5, 0] }}
                ...
                <Button
                  ...
                  variant="outline"
                  size="lg"
                  className="bg-transparent hover:bg-white/20 text-white border-2 border-white/30 hover:border-white/50 font-bold px-8 py-6 text-lg backdrop-blur-sm"
                  style={{ color: colors.accentGreen }}
                >
