        ...
        <div className="relative h-56 w-full overflow-hidden">
          ...
          >
            <div className="text-center text-white transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
              ...
              <p className="font-bold text-lg text-white">View Case Details</p>
            </div>
          </div>
        </div>

        <CardHeader className="pt-6 pb-3">
          <CardTitle className="text-xl font-bold" style={{ color: colors.textPrimary }}>{caseType.title}</CardTitle>
        </CardHeader>

        <CardContent className="pt-0 pb-4 flex-grow">
          <CardDescription className="line-clamp-3 leading-relaxed" style={{ color: colors.textSecondary }}>{caseType.shortDescription}</CardDescription>
          <div className="flex items-center mt-4 space-x-4 text-sm" style={{ color: colors.textSecondary }}>
...
const CaseTypesList = () => {
  ...
  return (
    <section id="case-types" className="py-20 md:py-28" style={{ backgroundColor: colors.background }}>
        ...
        <Tabs defaultValue={defaultTab} className="w-full">
          <div className="flex flex-col md:flex-row md:items-start md:space-x-12">
            ...
            <div className="md:w-5/12 lg:w-4/12 mb-12 md:mb-0 md:sticky md:top-28">
              <h2 className="text-4xl md:text-5xl font-black mb-4 leading-tight" style={{ color: colors.textPrimary }}>
                Explore Our Cases
              </h2>
