...
export const metadata: Metadata = {
  title: "Accessibility Statement | Justic Suppot Now",
  description: "Accessibility guidelines and accommodations for Justic Suppot Now",
};
  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <p>Justic Suppot Now is committed to ensuring digital accessibility for people with disabilities. We are continually improving the user experience for everyone and applying the relevant accessibility standards.</p>
        ...
        <p>Justic Suppot Now strives to conform to WCAG 2.1 level AA standards. We are working to ensure that our website is perceivable, operable, understandable, and robust for all users, regardless of ability.</p>
        ...
        <p>Despite our efforts to ensure accessibility of Justic Suppot Now, there may be some limitations. Below is a description of known limitations, and potential solutions. Please contact us if you observe an issue not listed below.</p>
        ...
        <p>Justic Suppot Now has conducted the following to assess and improve the accessibility of our website:</p>
        <ul className="list-disc pl-6 mb-4">
        ...
        <p>We welcome your feedback on the accessibility of Justic Suppot Now. Please let us know if you encounter accessibility barriers:</p>
        <p>Email: support@lexclaimconnect.com</p>
        <p>Phone: (914) 300 2717</p>
        ...
        <p>Justic Suppot Now is committed to continually improving accessibility for all users. We regularly review our website and services to identify and address accessibility issues, update our policies, and ensure that our accessibility goals are met.</p>
