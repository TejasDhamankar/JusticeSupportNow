...
export const metadata: Metadata = {
  title: "Legal Disclaimer | Justic Suppot Now",
  description: "Important legal disclaimers regarding the use of Justic Suppot Now services",
};
  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <p>Justic Suppot Now is not a law firm. We connect potential claimants with attorneys who handle mass tort and class action cases. No attorney-client relationship is created by your use of this website or by your submission of information through our case evaluation forms.</p>
        ...
        <p>Cases submitted through this website may be referred to third-party law firms or attorneys. Justic Suppot Now may receive a referral fee from these third parties in accordance with applicable state bar rules. The payment of such fees does not increase the amount charged to clients.</p>
