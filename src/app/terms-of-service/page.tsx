...
export const metadata: Metadata = {
  title: "Terms of Service | Justic Suppot Now",
  description: "Terms of Service for using Justic Suppot Now services",
};
  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <p>Welcome to Justic Suppot Now ("Company", "we", "our", "us"). These Terms of Service govern your use of our website located at <a href="https://lexclaimconnect.com">lexclaimconnect.com</a> (together or individually "Service") operated by Justic Suppot Now.</p>
        ...
        <p>The use of this website, including the submission of information through forms or other means, does not create an attorney-client relationship between you and Justic Suppot Now or any of its affiliated attorneys or law firms. An attorney-client relationship is only formed when there is an explicit agreement between you and a specific attorney or law firm to represent you.</p>
        ...
        <p>Justic Suppot Now may refer your case to third-party attorneys or law firms who are not employed by or affiliated with Justic Suppot Now. We do not guarantee the quality of representation provided by these third parties, and we are not responsible for their actions or omissions.</p>

        <h2 className="text-2xl font-semibold mt-8 mb-4">8. Links To Other Web Sites</h2>
        <p>Our Service may contain links to third-party web sites or services that are not owned or controlled by Justic Suppot Now. We have no control over, and assume no responsibility for, the content, privacy policies, or practices of any third-party web sites or services.</p>
